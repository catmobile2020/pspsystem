                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td class="size-80">
                                            <div class="btn-group-vertical">
                                                <a class="btn btn-blue" href="<?php echo e(route('callcenters.edit',$row->id)); ?>"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                                <a class="btn btn-danger" href="<?php echo e(route('callcenters.destroy',$row->id)); ?>"><i class="fa fa-trash-o"></i> Delete</a>
                                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmed_adel/Downloads/psp.cat-sw.com/resources/views/pages/callcenter/index.blade.php ENDPATH**/ ?>