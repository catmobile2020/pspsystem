                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeX">
                                        ...
                                        <td class="size-80">
                                            <a href="<?php echo e(route('marketing.index',$row->id)); ?>">Users</a>
                                            <a href="<?php echo e(route('companies.edit',$row->id)); ?>">Edit</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mahmoud\Desktop\pspsystem\resources\views/pages/company/index.blade.php ENDPATH**/ ?>