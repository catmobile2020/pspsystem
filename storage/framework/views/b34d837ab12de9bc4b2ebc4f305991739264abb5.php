        ...
        <div class='container'>
            ...
            <?php if(auth('pharmacy')->check()): ?>
                <div class='thing text-center'>
                    <a href="<?php echo e(route('orders.index',$single->id)); ?>">
                ...
                <div class='thing text-center'>
                    <a href="<?php echo e(route('orders.foc')); ?>">
                        <img src="<?php echo e(asset('assets/icons/orders.png')); ?>" style="height: 50px;">
                        <p class="title">Redeem Free Pack</p>
                    </a>
                </div>
                <?php $__currentLoopData = $single->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class='thing text-center'>
                        <a href="<?php echo e(route('orders.create',$product->id)); ?>">
                            <img src="<?php echo e($product->photo); ?>" style="height: 50px;">
                            <p class="title"><?php echo e($product->name); ?></p>
                            <p class="help-block"><?php echo e($product->description); ?></p>
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catsw/psp.cat-sw.com/resources/views/pages/order/company.blade.php ENDPATH**/ ?>