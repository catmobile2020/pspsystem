        ...
        <div class='container'>
            <div class='thing text-center'>
                <a href="/<?php echo e(explode('/',request()->route()->uri())[0]); ?>">
                    <img src="<?php echo e(asset('assets/icons/dashboard.png')); ?>" style="height: 50px;">
            ...
            <div class='thing text-center'>
                <a href="<?php echo e(route('programs.index')); ?>">
                    <img src="<?php echo e(asset('assets/icons/programs.png')); ?>" style="height: 50px;">
            ...
            <div class='thing text-center'>
                <a href="<?php echo e(route('companies.index')); ?>">
                    <img src="<?php echo e(asset('assets/icons/company.png')); ?>" style="height: 50px;">
            ...
            <div class='thing text-center'>
                <a href="<?php echo e(route('products.index')); ?>">
                    <img src="<?php echo e(asset('assets/icons/product.png')); ?>" style="height: 50px;">
                    <p class="title">Products</p>
                    <p class="help-block">Menu items with all data</p>
                </a>
            </div>
            <div class='thing text-center'>
                <a href="<?php echo e(route('callcenters.index')); ?>">
                    <img src="<?php echo e(asset('assets/icons/support.png')); ?>" style="height: 50px;">
            ...
            <div class='thing text-center'>
                <a href="<?php echo e(route('pharmacies.index')); ?>">
                    <img src="<?php echo e(asset('assets/icons/pharmacy.png')); ?>" style="height: 50px;">
            ...
            <div class='thing text-center'>
                <a href="<?php echo e(route('doctors.index')); ?>">
                    <img src="<?php echo e(asset('assets/icons/doctor.png')); ?>" style="height: 50px;">
            ...
            <div class='thing text-center'>
                <a href="<?php echo e(route('patients.index')); ?>">
                    <img src="<?php echo e(asset('assets/icons/patients.png')); ?>" style="height: 50px;">
                    <p class="title">Patients</p>
                    <p class="help-block">Menu items with all data</p>
                </a>
            </div>
            <?php endif; ?>
            <?php if(auth('pharmacy')->check()): ?>
                <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class='thing text-center'>
                        <a href="<?php echo e(route('single-company',$company->id)); ?>">
                            <img src="<?php echo e($company->photo); ?>" style="height: 50px;">
                            <p class="title"><?php echo e($company->name); ?></p>
                            <p class="help-block"><?php echo e($company->description); ?></p>
                        </a>
                    </div>
            ...
            <?php if(auth('marketing')->check()): ?>
                <div class='thing text-center'>
                    <a href="<?php echo e(route('statistics.index')); ?>">
                        <img src="<?php echo e(asset('assets/icons/statistics.png')); ?>" style="height: 50px;">
                        <p class="title">Statistics</p>
                    </a>
                </div>
            <?php endif; ?>
            <div class='thing text-center'>
                <a href="<?php echo e(route(explode('/',request()->route()->uri())[0].'.logout')); ?>">
                    <img src="<?php echo e(asset('assets/icons/logout.png')); ?>" style="height: 50px;">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmed_adel/Downloads/psp.cat-sw.com/resources/views/pages/home.blade.php ENDPATH**/ ?>