            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('orders.store',$single->id)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  value="<?php echo e($single->name); ?>" readonly>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catsw/psp.cat-sw.com/resources/views/pages/order/form.blade.php ENDPATH**/ ?>