...
@section('content')
    <div class="main-content">
        <h1 class="page-title">Pharmacy statistics</h1>
        <!-- Breadcrumb -->
        <ol class="breadcrumb breadcrumb-2">
            <li><a href="{{route('marketing.index')}}"><i class="fa fa-home"></i>Statistics</a></li>
            <li class="active"><strong>Pharmacy statistics</strong></li>
        </ol>
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        <div class="panel-title">Pharmacy log</div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading no-border clearfix">
                        <h3 class="panel-title">Packs Distribution</h3>
                    </div>
                    <div class="panel-body">
    ...
    <!--ChartJs-->
        ...
        <script>
            $(document).ready(function () {
                ...
                var programData = [
                    {
                        value: {{ $orders->where('has_free', 1)->count() }},
                        color: "red",
                        highlight: "green",
                        label: "Free Packs"
                    },
                    {
                        value: {{ $orders->where('has_free', 0)->count() }},
                        color: "blue",
                        highlight: "green",
                        label: "Paid Packs"
                    }
