...
@section('title','Healthcare statistics')
@section('css')
    <style>
        li h5 {
            text-align:left;
...
@section('content')
    <div class="main-content">
        <h1 class="page-title">Healthcare statistics</h1>
        <!-- Breadcrumb -->
        <ol class="breadcrumb breadcrumb-2">
            <li><a href="{{route('marketing.index')}}"><i class="fa fa-home"></i>Statistics</a></li>
            <li class="active"><strong>Healthcare statistics</strong></li>
        </ol>
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <tr>
                                    ...
                                    <th>Phone</th>
                                    <th>Address</th>
                                    <th># of used vouchers</th>
                                    <th># of all all vouchers</th>
                                    <th># of patients</th>
                                    <th>Created At</th>
                                </tr>
                                </thead>
                                ...
                                @foreach($rows as $row)
                                    <tr class="gradeX">
                                        ...
                                        <td>{{$row->phone}}</td>
                                        <td>{{$row->address}}</td>
                                        <td>{{$row->vouchers->where('was_used',1)->count()}}</td>
                                        <td>{{$row->vouchers->count()}}</td>
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading no-border clearfix">
                        <h3 class="panel-title">Voucher Distribution</h3>
                    </div>
                    <div class="panel-body">
    ...
    <!--ChartJs-->
        ...
        <script>
            $(document).ready(function () {
                ...
                var programData = [
                    {
                        value: {{ $tests->where('was_used', 1)->count() }},
                        color: "red",
                        highlight: "green",
                        label: "Used Vouchers"
                    },
                    {
                        value: {{ $tests->where('was_used', 0)->count() }},
                        color: "blue",
                        highlight: "green",
