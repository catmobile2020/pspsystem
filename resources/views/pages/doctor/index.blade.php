            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        <a href="{{route('doctors.create')}}" class="btn btn-success">Add New</a>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                @foreach($rows as $row)
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <a href="{{route('doctors.cards',$row->id)}}" class="btn btn-info">Patient Cards</a>
                                        </td>
                                        <td class="size-80">
                                            <div class="btn-group-vertical">
                                                <a class="btn btn-blue" href="{{route('doctors.edit',$row->id)}}"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                                <a class="btn btn-danger" href="{{route('doctors.destroy',$row->id)}}"><i class="fa fa-trash-o"></i> Delete</a>
                                            </div>
{{--                                            <div class="dropdown">--}}
